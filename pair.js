...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'Raviya-cmd';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'Ravi-md v1';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
